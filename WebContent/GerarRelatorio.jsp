...
<body>
	...
	<div class="col-md-8" id ="main_div_relatorio">
		<form method="post" action="/First_Web/GerarRelatorioController" style="padding:10px; border-style:solid;border-width:2px; border-color:gray; background-color:white">
			<div >
